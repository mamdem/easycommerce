    ...
    <div class="product-details" *ngIf="product$ | async as product">
      <div class="product-header">
        <div class="header-content">
          <h1>{{ product.name }}</h1>
          <div class="category-tag" *ngIf="product.categoryName">
            ...
            <div class="details-grid">
              ...
              <div class="detail-item">
                ...
                <span class="value status-badge" [class.active]="product.isActive">
                  <i class="bi" [ngClass]="product.isActive ? 'bi-check-circle-fill' : 'bi-x-circle-fill'"></i>
                  {{ product.isActive ? 'Actif' : 'Inactif' }}
                </span>
              </div>
              <div class="detail-item">
                <span class="label">Créé le</span>
                <span class="value">{{ product.createdAt | date:'dd/MM/yyyy à HH:mm:ss' }}</span>
              </div>
              <div class="detail-item">
                <span class="label">Dernière mise à jour</span>
                <span class="value">{{ product.updatedAt | date:'dd/MM/yyyy à HH:mm:ss' }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="info-section" *ngIf="product.promotion">
            ...
            <div class="promotion-details">
              ...
              <div class="promotion-info">
                ...
                <p class="promotion-usage" *ngIf="product.promotion.utilisationsMax">
              ...
              switchMap(product => {
                ...
                const productWithDates = {
                  ...
                  createdAt: product.createdAt instanceof Date 
                    ? product.createdAt 
                    : new Date((product.createdAt as FirestoreTimestamp).seconds * 1000),
                  updatedAt: product.updatedAt instanceof Date 
                    ? product.updatedAt 
                    : new Date((product.updatedAt as FirestoreTimestamp).seconds * 1000)
                };
                ...
                return this.promotionService.getPromotions(store.id).pipe(
                  map(promotions => {
                    ...
                    const applicablePromotion = this.priceService.getApplicablePromotion(productWithDates, activePromotions);
                    const productWithPromotion: ProductWithPromotion = {
                      ...productWithDates,
                      originalPrice: productWithDates.price,
                    ...
                    if (applicablePromotion) {
                      ...
                      productWithPromotion.discountedPrice = productWithDates.price * (1 - applicablePromotion.reduction / 100);
                    }
